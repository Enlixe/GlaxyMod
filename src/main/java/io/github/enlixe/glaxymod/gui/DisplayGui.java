...
public class DisplayGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        zombie = new GuiButton(0, width / 2 - 230, (int) (height * 0.3), 110, 20, "Zombie");
        spider = new GuiButton(0, width / 2 - 110, (int) (height * 0.3), 110, 20, "Spider");
        wolf = new GuiButton(0, width / 2 + 10, (int) (height * 0.3), 110, 20, "Wolf");
        enderman = new GuiButton(0, width / 2 + 130, (int) (height * 0.3), 110, 20, "Enderman");
