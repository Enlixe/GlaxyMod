...
public class FasterMaddoxCalling {
    ...
    public void onChat(ClientChatReceivedEvent event) {
        ...
        if (message.contains("[OPEN MENU]")) {
            ...
            if (ToggleCommand.chatMaddoxToggled) Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Open chat then click anywhere on-screen to open Maddox"));
        }
    }
    ...
    public void onKey(InputEvent.KeyInputEvent event) {
        ...
        if (Glaxy.keyBindings[0].isPressed()) {
