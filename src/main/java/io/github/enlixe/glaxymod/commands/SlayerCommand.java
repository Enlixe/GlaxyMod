...
public class SlayerCommand extends CommandBase {
    ...
    public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
        ...
        new Thread(() -> {
            ...
            if (key.equals("")) {
                player.addChatMessage(new ChatComponentText(Glaxy.ERROR_COLOUR + "API key not set. Use /setkey."));
            }
            ...
            if (arg1.length == 0) {
                ...
                player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Checking slayer of " + Glaxy.SECONDARY_COLOUR + username));
            } else {
                username = arg1[0];
                player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Checking slayer of " + Glaxy.SECONDARY_COLOUR + username));
            ...
            player.addChatMessage(new ChatComponentText(Glaxy.DELIMITER_COLOUR + "" + EnumChatFormatting.BOLD + "-------------------\n" +
                    ...
                    Glaxy.TYPE_COLOUR + " Zombie XP: " + Glaxy.VALUE_COLOUR + EnumChatFormatting.BOLD + nf.format(zombieXP) + "\n" +
                    Glaxy.TYPE_COLOUR + " Spider XP: " + Glaxy.VALUE_COLOUR + EnumChatFormatting.BOLD + nf.format(spiderXP) + "\n" +
                    Glaxy.TYPE_COLOUR + " Wolf XP: " + Glaxy.VALUE_COLOUR + EnumChatFormatting.BOLD + nf.format(wolfXP) + "\n" +
                    Glaxy.DELIMITER_COLOUR + " " + EnumChatFormatting.BOLD + "-------------------"));
