...
public class DisplayCommand extends CommandBase {
    ...
    public void processCommand(ICommandSender arg0, String[] arg1) throws CommandException {
        ...
        switch (arg1[0].toLowerCase()) {
            ...
            case "catacombs":
                if (arg1.length == 1) {
                    player.addChatMessage(new ChatComponentText(Glaxy.ERROR_COLOUR + "Usage: /display catacombs <f1/f2/f3/f4f5/f6/f7>"));
                    return;
                }
                ...
                switch (arg1[1].toLowerCase()) {
                    ...
                    case "floor7":
                        ...
                        break;
                    default:
                        player.addChatMessage(new ChatComponentText(Glaxy.ERROR_COLOUR + "Usage: /display catacombs <f1/f2/f3/f4/f5/f6/f7>"));
                        return;
                }
                break;
            case "ghost":
            ...
            case "auto":
                ...
                player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Display set to " + Glaxy.SECONDARY_COLOUR + "auto" + Glaxy.MAIN_COLOUR + "."));
        ...
        player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Display set to " + Glaxy.SECONDARY_COLOUR + LootDisplay.display + Glaxy.MAIN_COLOUR + "."));
