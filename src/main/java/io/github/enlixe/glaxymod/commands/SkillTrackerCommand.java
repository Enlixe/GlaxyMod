            ...
            try {
                ...
                switch (arg1[0].toLowerCase()) {
                    ...
                    case "resume":
                        ...
                        player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Skill tracker started."));
                        break;
                    case "pause":
                    case "stop":
                        if (SkillTracker.skillStopwatch.isStarted() && !SkillTracker.skillStopwatch.isSuspended()) {
                            ...
                            player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Skill tracker paused."));
                        }
                        break;
                    case "reset":
                        ...
                        player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Skill tracker reset."));
                        break;
                    case "hide":
                        SkillTracker.showSkillTracker = false;
                        ConfigHandler.writeBooleanConfig("misc", "showSkillTracker", false);
                        player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Skill tracker hidden."));
                        break;
                    case "show":
                        SkillTracker.showSkillTracker = true;
                        ConfigHandler.writeBooleanConfig("misc", "showSkillTracker", true);
                        player.addChatMessage(new ChatComponentText(Glaxy.MAIN_COLOUR + "Skill tracker shown."));
                        break;
                    default:
                        player.addChatMessage(new ChatComponentText(Glaxy.ERROR_COLOUR + "Usage: " + getCommandUsage(arg0)));
                }
